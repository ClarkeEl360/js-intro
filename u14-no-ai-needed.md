...
*Height, Birth Date, EMail, etc*

3. If you had to explain the `=` symbol to a non-coder using the analogy of a "bucket" and a "ball," how would you describe it?

*`=` assignes something to something, in other words you can have a ball, and assingn it the value of inBucket, or outOfBucket*
...
const playetHeight = 68;
const startDate = "Dec, 13 2024";
const playerEMail = "example@gmail.com";
```
